...
public class StationServiceTest {
    ...
    public void testDeleteStationThrowsExceptionWhenNotFound() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> stationService.deleteStation(1));
    ...
    public void testUpdateStationThrowsExceptionWhenNotFound() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> stationService.updateStation(1, sampleStation));
