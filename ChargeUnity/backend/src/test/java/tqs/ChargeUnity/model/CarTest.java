...
class CarTest {
  ...
  void testCarToString() {
    ...
    String expected =
        "Car 101 - Driver: John Doe(1);Tesla Model S; Battery Capacity: 100.0kWh; Battery Level:"
            + " 80.0kWh; Consumption per Km: 0.2kWh/Km; Kilometers: 50000km;";
  ...
  void testBatteryPercentageLimits() {
    ...
    Exception exception =
        assertThrows(IllegalArgumentException.class, () -> car.setBatteryPercentage(120.0));
    ...
    Exception exception2 =
        assertThrows(IllegalArgumentException.class, () -> car.setBatteryPercentage(-10.0));
  ...
  void testConsumptionPerKmBounds() {
    ...
    Exception exception =
        assertThrows(IllegalArgumentException.class, () -> car.setConsumptionPerKm(-0.1));
    assertEquals("Consumption per Km must be positive.", exception.getMessage());

    // Test with a consumption per Km zero
    Exception exception2 =
        assertThrows(IllegalArgumentException.class, () -> car.setConsumptionPerKm(0.0));
  ...
  void testKilometersBounds() {
    ...
    Exception exception =
        assertThrows(IllegalArgumentException.class, () -> car.setKilometers(-100L));
    assertEquals("Kilometers must be positive.", exception.getMessage());

    // Test with zero kilometers
    Exception exception2 =
        assertThrows(IllegalArgumentException.class, () -> car.setKilometers(0L));
  ...
  void testBatteryCapacityBounds() {
    ...
    Exception exception =
        assertThrows(IllegalArgumentException.class, () -> car.setBatteryCapacity(-50.0));
    assertEquals("Battery capacity must be positive.", exception.getMessage());

    // Test with a battery capacity zero
    Exception exception2 =
        assertThrows(IllegalArgumentException.class, () -> car.setBatteryCapacity(0.0));
