...
public class SearchChargerSteps {
    ...
    public void they_enter_their_current_location_or_a_destination() {
        WebElement cityRadio =
            wait.until(ExpectedConditions.elementToBeClickable(By.id("city-radio")));
        cityRadio.click();

        WebElement cityInput =
            wait.until(ExpectedConditions.elementToBeClickable(By.id("city-input")));
